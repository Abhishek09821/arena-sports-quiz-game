    ...
    <main>
      ...
      <section className="arena-container pt-20 sm:pt-32 pb-12 relative">
        <div className="max-w-[900px]">
          ...
          <h1 className="arena-hero-title font-display text-[clamp(52px,9vw,120px)] leading-[0.88] tracking-[-0.065em]">
            <motion.span
              className="block"
          ...
          >
            Sports and general knowledge. Three ways to compete. Beat the buzzer, challenge your friends, or prove how well you know your idol.
          </motion.p>
          ...
          <div className="arena-card p-5 border border-arena-accent/30 bg-gradient-to-r from-arena-accent/10 via-white/[.02] to-purple-500/10 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3.5">
              ...
              <div>
                ...
                <p className="text-xs text-arena-muted">Paste a challenge code shared by a friend to jump straight into their custom trivia deck.</p>
              </div>
            </div>
            <form
              onSubmit={(e) => {
            ...
            >
              ...
              <button
                ...
                className="arena-btn arena-btn-primary justify-center text-xs whitespace-nowrap py-3 px-5 w-full sm:w-auto"
              >
