    ...
    <main>
      ...
      <footer className="arena-container py-12 mt-8">
        ...
        <div className="grid gap-8 lg:grid-cols-[minmax(0,0.85fr)_minmax(0,1.15fr)]">
          ...
          <section aria-labelledby="footer-faq-title" className="min-w-0">
            ...
            <div className="grid gap-2">
              {[
                ...
                ["Which sports can I play?", "Arena currently covers Cricket, Football, Basketball, Formula 1, WWE/WWF, and UFC across multiple game modes."],
